...
{
	//New ECS functionality:
	//auto testEntity = m_entityManager.CreateEntity();
	
	//auto& tc = m_entityManager.AddOrReplaceComponent<TestComponent>(testEntity, 1);
	//auto& tc2 = m_entityManager.AddOrReplaceComponent<TestComponent>(testEntity, 2);

	//m_entityManager.RemoveComponentIfExists<TestComponent>(testEntity);
	//m_entityManager.AddComponent<TestComponent>(testEntity);
	//m_entityManager.RemoveComponentIfExists<TestComponent>(testEntity);

	//auto& tc = m_entityManager.AddOrGetComponent<TestComponent>(testEntity, 1);
	//auto& tc1 = m_entityManager.AddOrGetComponent<TestComponent>(testEntity, 7);

	//auto h = m_entityManager.TryGetComponent<DOG::TransformComponent>(testEntity);
	//if (h == std::nullopt)
	//{
	//	__debugbreak();
	//}
	//else
	//{
	//	DOG::TransformComponent& tc = *h;
	//	auto pos = tc.GetPosition();
	//	std::cout << pos.x << pos.y << pos.z;
	//	tc.SetPosition({ 111.0f, 111.0f, 111.0f });
	//}
	//
	//auto h1 = m_entityManager.TryGetComponent<DOG::TransformComponent>(testEntity);
	//if (h1 == std::nullopt)
	//{
	//	__debugbreak();
	//}
