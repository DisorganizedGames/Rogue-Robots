...
namespace DOG::gfx
{
	...
	public:
		...
		public:
			...
			// Texture read views
			RGResourceView ReadResource(RGResourceID id, D3D12_RESOURCE_STATES state, TextureViewDesc desc);
			RGResourceView ReadResource(RGResourceID id, D3D12_RESOURCE_STATES state, BufferViewDesc desc);
